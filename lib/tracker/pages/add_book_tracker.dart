...
class AddBookTracker extends StatefulWidget {
  const AddBookTracker({super.key});
        ...
        child: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              padding: const EdgeInsets.only(right: 20.0, left: 20.0, top: 35.0, bottom: 40.0),
              child: Container(
                  decoration: BoxDecoration(
                  color: Colors.white,
                  shape: BoxShape.rectangle,
                  borderRadius: BorderRadius.all(Radius.circular(40.0))),
                  padding: const EdgeInsets.only(right: 30.0, left: 30.0, top: 40.0, bottom: 30.0),
                  child: Column(
                    children: [
                      Padding(
